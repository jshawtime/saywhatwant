...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ toggleVideo, userColor, userColorRgb }) => {
  ...
  // Fetch manifest and initialize videos immediately
  // No artificial delays - if a version mismatch reload happens, the page will reload
  // and the video will start again (this is rare, only after deployments)
  useEffect(() => {
    loadVideoManifest();
  }, []);
